...
View(base2020)
#base2020$class <- fct_recode(base2020$class,pos = "1", neg = "0")
...
View(anos_ant)
#anos_ant$class <- fct_recode(anos_ant$class,pos = "1", neg = "0")
...
for(i in 2:163) {
  hist(base2020[,i], main = names(base2020)[i])
}


####### Ver a correlação entre as variáveis ########
library(corrplot)
correlacao <- cor(base2020[,1:163])
